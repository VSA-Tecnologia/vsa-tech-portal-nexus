            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                ...
                field
                      ...
                      <FormControl>
                        <Input placeholder="seu@email.com" {...field} autoComplete="email" disabled={isLoading} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>} />
                ...
                field
                      ...
                      <FormControl>
                        <Input type="password" placeholder="********" {...field} autoComplete="current-password" disabled={isLoading} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>} />
                
                <Button type="submit" className="w-full bg-vsa-teal hover:bg-vsa-teal-dark" disabled={isLoading}>
                  {isLoading ? <Loader2 className="mr-2 h-4 w-4 animate-spin" /> : null}
                  Entrar
                </Button>
                
                <div className="text-center text-sm">
                  <Link to="/admin/forgot-password" className="text-vsa-teal hover:underline">
                    Esqueceu sua senha?
                  </Link>
                </div>
              </form>
